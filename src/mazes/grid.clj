...
(defprotocol Grid
  ...
  (get-cell [this coord]
    "Gets the cell located at `coord`")
  (iter-coords [this]
...
(defrecord SimpleGrid [rows cols cells]
  Grid
  (get-cell [this coord] (get-cell-simple this coord))
  (iter-coords [this] (all-coords-for rows cols))
  (iter-row [this y] (iter-single-row this y)))

  ...
  (testing "SVG polar test prints successfully"
    (binding [gen/*rnd* (java.util.Random. 3)]
      (let [maze (algo/recursive-backtracker (polar/new-grid 3))]
        (is (= (svg-polar maze)
               [:dali/page {:width 301, :height 301}
                [:rect {:fill :white} [0 0] [301 301]]
                [:circle {:fill :white, :stroke :black} [150 150] 150]
                '(nil [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [200 150] :A [50 50] 0.0 false true [175 193]]
                       [:line {:stroke :black, :fill :white} [175 193] [200 236]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [175 193] :A [50 50] 1.0471975511965976 false true [126 193]]
                       [:line {:stroke :white, :fill :white} [126 193] [101 236]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [126 193] :A [50 50] 2.0943951023931953 false true [100 150]]
                       [:line {:stroke :black, :fill :white} [100 150] [50 150]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [100 150] :A [50 50] 3.141592653589793 false true [125 107]]
                       [:line {:stroke :black, :fill :white} [125 107] [100 64]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [125 107] :A [50 50] 4.1887902047863905 false true [174 107]]
                       [:line {:stroke :black, :fill :white} [174 107] [199 64]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [174 107] :A [50 50] 5.235987755982988 false true [200 150]]
                       [:line {:stroke :black, :fill :white} [200 150] [250 150]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [250 150] :A [100 100] 0.0 false true [236 199]]
                       [:line {:stroke :black, :fill :white} [236 199] [279 224]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [236 199] :A [100 100] 0.5235987755982988 false true [200 236]]
                       [:line {:stroke :white, :fill :white} [200 236] [225 279]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [200 236] :A [100 100] 1.0471975511965976 false true [150 250]]
                       [:line {:stroke :black, :fill :white} [150 250] [150 300]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [150 250] :A [100 100] 1.5707963267948966 false true [101 236]]
                       [:line {:stroke :white, :fill :white} [101 236] [76 279]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [101 236] :A [100 100] 2.0943951023931953 false true [64 200]]
                       [:line {:stroke :black, :fill :white} [64 200] [21 225]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [64 200] :A [100 100] 2.617993877991494 false true [50 150]]
                       [:line {:stroke :white, :fill :white} [50 150] [0 150]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [50 150] :A [100 100] 3.141592653589793 false true [64 101]]
                       [:line {:stroke :white, :fill :white} [64 101] [21 76]]]
                      [:dali/page
                       [:path {:stroke :black, :fill :white}
                        :M [64 101] :A [100 100] 3.665191429188092 false true [100 64]]
                       [:line {:stroke :white, :fill :white} [100 64] [75 21]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [100 64] :A [100 100] 4.1887902047863905 false true [150 50]]
                       [:line {:stroke :black, :fill :white} [150 50] [150 0]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [150 50] :A [100 100] 4.71238898038469 false true [199 64]]
                       [:line {:stroke :white, :fill :white} [199 64] [224 21]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [199 64] :A [100 100] 5.235987755982988 false true [236 100]]
                       [:line {:stroke :black, :fill :white} [236 100] [279 75]]]
                      [:dali/page
                       [:path {:stroke :white, :fill :white}
                        :M [236 100] :A [100 100] 5.759586531581287 false true [250 150]]
                       [:line {:stroke :white, :fill :white} [250 150] [300 150]]])]))))))

  ...
  (testing "SVG maze with coloured distances renders correctly"
    (binding [gen/*rnd* (java.util.Random. 3)]
      (let [maze (algo/aldous-broder (grid/new-grid 3 3))]
        (is (= (to-svg maze {:distances (dist/dijkstra maze [0 0])})
  ...
  (testing "SVG polar test prints successfully"
    (binding [gen/*rnd* (java.util.Random. 3)]
      (let [maze (algo/recursive-backtracker (polar/new-grid 3))]
        (is (= (to-svg maze)
[:dali/page {:width 301, :height 301} [:rect {:fill :white} [0 0] [301 301]] '([:dali/page {:fill :none} [:circle {:cx 150, :cy 150, :r 50}]] [:dali/page [:path {:fill :none, :stroke :none} :M [200 150] :L [250 150] :A [100 100] 0.0 false true [200 236] :L [175 193] :A [50 50] 0.0 false false [200 150] :z] [:path {:stroke :black, :fill :none} :M [200 150] :A [50 50] 0.0 false true [175 193]] [:line {:stroke :black, :fill :none} [175 193] [200 236]]] [:dali/page [:path {:fill :none, :stroke :none} :M [175 193] :L [200 236] :A [100 100] 1.0471975511965976 false true [101 236] :L [126 193] :A [50 50] 1.0471975511965976 false false [175 193] :z] [:path {:stroke :black, :fill :none} :M [175 193] :A [50 50] 1.0471975511965976 false true [126 193]] [:line {:stroke :none, :fill :none} [126 193] [101 236]]] [:dali/page [:path {:fill :none, :stroke :none} :M [126 193] :L [101 236] :A [100 100] 2.0943951023931953 false true [50 150] :L [100 150] :A [50 50] 2.0943951023931953 false false [126 193] :z] [:path {:stroke :none, :fill :none} :M [126 193] :A [50 50] 2.0943951023931953 false true [100 150]] [:line {:stroke :black, :fill :none} [100 150] [50 150]]] [:dali/page [:path {:fill :none, :stroke :none} :M [100 150] :L [50 150] :A [100 100] 3.141592653589793 false true [100 64] :L [125 107] :A [50 50] 3.141592653589793 false false [100 150] :z] [:path {:stroke :black, :fill :none} :M [100 150] :A [50 50] 3.141592653589793 false true [125 107]] [:line {:stroke :black, :fill :none} [125 107] [100 64]]] [:dali/page [:path {:fill :none, :stroke :none} :M [125 107] :L [100 64] :A [100 100] 4.1887902047863905 false true [199 64] :L [174 107] :A [50 50] 4.1887902047863905 false false [125 107] :z] [:path {:stroke :black, :fill :none} :M [125 107] :A [50 50] 4.1887902047863905 false true [174 107]] [:line {:stroke :black, :fill :none} [174 107] [199 64]]] [:dali/page [:path {:fill :none, :stroke :none} :M [174 107] :L [199 64] :A [100 100] 5.235987755982988 false true [250 150] :L [200 150] :A [50 50] 5.235987755982988 false false [174 107] :z] [:path {:stroke :black, :fill :none} :M [174 107] :A [50 50] 5.235987755982988 false true [200 150]] [:line {:stroke :black, :fill :none} [200 150] [250 150]]] [:dali/page [:path {:fill :none, :stroke :none} :M [250 150] :L [300 150] :A [150 150] 0.0 false true [279 224] :L [236 199] :A [100 100] 0.0 false false [250 150] :z] [:path {:stroke :none, :fill :none} :M [250 150] :A [100 100] 0.0 false true [236 199]] [:line {:stroke :black, :fill :none} [236 199] [279 224]]] [:dali/page [:path {:fill :none, :stroke :none} :M [236 199] :L [279 224] :A [150 150] 0.5235987755982988 false true [225 279] :L [200 236] :A [100 100] 0.5235987755982988 false false [236 199] :z] [:path {:stroke :none, :fill :none} :M [236 199] :A [100 100] 0.5235987755982988 false true [200 236]] [:line {:stroke :none, :fill :none} [200 236] [225 279]]] [:dali/page [:path {:fill :none, :stroke :none} :M [200 236] :L [225 279] :A [150 150] 1.0471975511965976 false true [150 300] :L [150 250] :A [100 100] 1.0471975511965976 false false [200 236] :z] [:path {:stroke :none, :fill :none} :M [200 236] :A [100 100] 1.0471975511965976 false true [150 250]] [:line {:stroke :black, :fill :none} [150 250] [150 300]]] [:dali/page [:path {:fill :none, :stroke :none} :M [150 250] :L [150 300] :A [150 150] 1.5707963267948966 false true [76 279] :L [101 236] :A [100 100] 1.5707963267948966 false false [150 250] :z] [:path {:stroke :black, :fill :none} :M [150 250] :A [100 100] 1.5707963267948966 false true [101 236]] [:line {:stroke :none, :fill :none} [101 236] [76 279]]] [:dali/page [:path {:fill :none, :stroke :none} :M [101 236] :L [76 279] :A [150 150] 2.0943951023931953 false true [21 225] :L [64 200] :A [100 100] 2.0943951023931953 false false [101 236] :z] [:path {:stroke :none, :fill :none} :M [101 236] :A [100 100] 2.0943951023931953 false true [64 200]] [:line {:stroke :black, :fill :none} [64 200] [21 225]]] [:dali/page [:path {:fill :none, :stroke :none} :M [64 200] :L [21 225] :A [150 150] 2.617993877991494 false true [0 150] :L [50 150] :A [100 100] 2.617993877991494 false false [64 200] :z] [:path {:stroke :black, :fill :none} :M [64 200] :A [100 100] 2.617993877991494 false true [50 150]] [:line {:stroke :none, :fill :none} [50 150] [0 150]]] [:dali/page [:path {:fill :none, :stroke :none} :M [50 150] :L [0 150] :A [150 150] 3.141592653589793 false true [21 76] :L [64 101] :A [100 100] 3.141592653589793 false false [50 150] :z] [:path {:stroke :none, :fill :none} :M [50 150] :A [100 100] 3.141592653589793 false true [64 101]] [:line {:stroke :none, :fill :none} [64 101] [21 76]]] [:dali/page [:path {:fill :none, :stroke :none} :M [64 101] :L [21 76] :A [150 150] 3.665191429188092 false true [75 21] :L [100 64] :A [100 100] 3.665191429188092 false false [64 101] :z] [:path {:stroke :black, :fill :none} :M [64 101] :A [100 100] 3.665191429188092 false true [100 64]] [:line {:stroke :none, :fill :none} [100 64] [75 21]]] [:dali/page [:path {:fill :none, :stroke :none} :M [100 64] :L [75 21] :A [150 150] 4.1887902047863905 false true [150 0] :L [150 50] :A [100 100] 4.1887902047863905 false false [100 64] :z] [:path {:stroke :none, :fill :none} :M [100 64] :A [100 100] 4.1887902047863905 false true [150 50]] [:line {:stroke :black, :fill :none} [150 50] [150 0]]] [:dali/page [:path {:fill :none, :stroke :none} :M [150 50] :L [150 0] :A [150 150] 4.71238898038469 false true [224 21] :L [199 64] :A [100 100] 4.71238898038469 false false [150 50] :z] [:path {:stroke :none, :fill :none} :M [150 50] :A [100 100] 4.71238898038469 false true [199 64]] [:line {:stroke :none, :fill :none} [199 64] [224 21]]] [:dali/page [:path {:fill :none, :stroke :none} :M [199 64] :L [224 21] :A [150 150] 5.235987755982988 false true [279 75] :L [236 100] :A [100 100] 5.235987755982988 false false [199 64] :z] [:path {:stroke :none, :fill :none} :M [199 64] :A [100 100] 5.235987755982988 false true [236 100]] [:line {:stroke :black, :fill :none} [236 100] [279 75]]] [:dali/page [:path {:fill :none, :stroke :none} :M [236 100] :L [279 75] :A [150 150] 5.759586531581287 false true [300 150] :L [250 150] :A [100 100] 5.759586531581287 false false [236 100] :z] [:path {:stroke :none, :fill :none} :M [236 100] :A [100 100] 5.759586531581287 false true [250 150]] [:line {:stroke :none, :fill :none} [250 150] [300 150]]]) [:circle {:fill :none, :stroke :black} [150 150] 150]]))))))

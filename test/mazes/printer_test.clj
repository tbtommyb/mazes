      ...
      (let [maze (algo/aldous-broder (grid/new-grid 3 3))]
        (is (= (to-svg maze (dist/dijkstra maze [0 0]))
               [:dali/page {:width 150, :height 150}
                ...
                '([:dali/page [:line {:stroke :black} [0 150] [50 150]]
                  [:line {:stroke :black} [0 150] [0 100]]]
                 [:dali/page [:line {:stroke :black} [0 100] [50 100]]
                  [:line {:stroke :black} [0 100] [0 50]]]
                 [:dali/page [:line {:stroke :black} [0 50] [50 50]]
                  [:line {:stroke :black} [0 50] [0 0]]]
                 [:dali/page [:line {:stroke :black} [50 150] [100 150]]
                  [:line {:stroke "rgb(218,236,218)"} [50 150] [50 100]]]
                 [:dali/page [:line {:stroke :black} [50 100] [100 100]]
                  [:line {:stroke "rgb(36,146,36)"} [50 100] [50 50]]]
                 [:dali/page [:line {:stroke "rgb(72,164,72)"} [50 50] [100 50]]
                  [:line {:stroke "rgb(72,164,72)"} [50 50] [50 0]]]
                 [:dali/page [:line {:stroke :black} [100 150] [150 150]]
                  [:line {:stroke "rgb(182,218,182)"} [100 150] [100 100]]]
                 [:dali/page [:line {:stroke "rgb(145,200,145)"} [100 100] [150 100]]
                  [:line {:stroke :black} [100 100] [100 50]]]
                 [:dali/page [:line {:stroke "rgb(109,182,109)"} [100 50] [150 50]]
        ...
        (is (= (to-svg maze (dist/dijkstra maze [0 0]))
               [:dali/page {:width 250, :height 150}
                ...
                '([:dali/page [:line {:stroke :black} [0 150] [50 150]]
                 ...
                 [:dali/page [:line {:stroke "rgb(170,212,170)"} [50 100] [100 100]]
                  [:line {:stroke "rgb(170,212,170)"} [50 100] [50 50]]]
                 [:dali/page [:line {:stroke "rgb(127,191,127)"} [50 50] [100 50]]
                  [:line {:stroke :black} [50 50] [50 0]]]
                 [:dali/page [:line {:stroke :black} [100 150] [150 150]]
                  [:line {:stroke "rgb(170,212,170)"} [100 150] [100 100]]]
                 [:dali/page [:line {:stroke :black} [100 100] [150 100]]
                  [:line {:stroke :black} [100 100] [100 50]]]
                 [:dali/page [:line {:stroke :black} [100 50] [150 50]]
                  [:line {:stroke :black} [100 50] [100 0]]]
                 [:dali/page [:line {:stroke :black} [150 150] [200 150]]
                  [:line {:stroke "rgb(127,191,127)"} [150 150] [150 100]]]
                 [:dali/page [:line {:stroke "rgb(85,170,85)"} [150 100] [200 100]]
                  [:line {:stroke :black} [150 100] [150 50]]]
                 [:dali/page [:line {:stroke "rgb(42,149,42)"} [150 50] [200 50]]
                  [:line {:stroke "rgb(42,149,42)"} [150 50] [150 0]]]
                 [:dali/page [:line {:stroke :black} [200 150] [250 150]]
                  [:line {:stroke :black} [200 150] [200 100]]]
                 [:dali/page [:line {:stroke :black} [200 100] [250 100]]
                  [:line {:stroke "rgb(42,149,42)"} [200 100] [200 50]]]
                 [:dali/page [:line {:stroke :black} [200 50] [250 50]]
